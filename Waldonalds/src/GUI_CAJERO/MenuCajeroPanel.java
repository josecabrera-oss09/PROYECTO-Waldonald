...
public class MenuCajeroPanel extends javax.swing.JPanel {
    ...
    CategoriasPanel categorias =
        new CategoriasPanel();

    scroll_Categorias1.setPanelCategorias(
            categorias
    );
    ...
    private void initComponents() {
        ...
        add(scroll_Categorias1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 1790, 300));
